      ...
      <div class="w-full max-w-4xl mx-auto">
        <div class="flex flex-col gap-8">
          ...
          <div class="text-center transition-all duration-1000 ease-out" :class="{ 'opacity-0 translate-y-8': !isVisible, 'opacity-100 translate-y-0': isVisible }">
            <h1 class="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-purple-200 to-indigo-200 bg-clip-text text-transparent">
              Get In Touch
            </h1>
          ...
          <!-- Contact Card -->
          <div class="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 md:p-12 transition-all duration-1000 ease-out hover:bg-white/10 transform hover:scale-[1.02]" :class="{ 'opacity-0 translate-y-8': !isVisible, 'opacity-100 translate-y-0': isVisible }" style="transition-delay: 200ms;">
            
            <!-- Success Message -->
            <div v-if="isSubmitted" class="text-center py-8 transition-all duration-500 ease-out">
              <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center animate-pulse">
                <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
              </div>
              <h3 class="text-2xl md:text-3xl font-bold mb-4 bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">
            ...
            <form v-else @submit="handleSubmit" class="space-y-8">
              ...
              <div class="form-group">
                <label class="flex items-center gap-2 mb-3 font-semibold text-lg text-purple-200">
                ...
                <input
                  ...
                  maxlength="50"
                  class="w-full px-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/15"
                  :class="{ 'border-red-500 focus:ring-red-500': errors.name }"
                />
                <div class="flex justify-between items-center mt-2">
                  <span v-if="errors.name" class="text-red-400 text-sm">{{ errors.name }}</span>
                  <span class="text-gray-500 text-sm ml-auto">{{ formData.name.length }}/50</span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  rows="5"
                  maxlength="500"
                  class="w-full px-4 py-4 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/15 resize-none"
                ...
                <div class="flex justify-between items-center mt-2">
                  ...
                  <span class="text-gray-500 text-sm ml-auto">{{ formData.message.length }}/500</span>
                </div>
              </div>
              ...
              <button
                ...
                class="w-full px-8 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 disabled:hover:scale-100 disabled:hover:shadow-none flex items-center justify-center gap-3"
              >
